...
def call_skyview(field, survey, pos, fov, coord, proj='Car', pix=500):
    ...
    cmd = 'java -jar /home/ricci/Documents/work/Tools/VO_tools/skyview.jar coordinates={coord} projection={proj} position={x:.4f},{y:.4f} size={fov},{fov} pixels={pix},{pix} survey="{survey}" output="results/{fitsname}"'.format(**locals())
    print(cmd)
